...
**開いている Issue は #112 / #42 とこの記録の #137 だけ。次は #42（同梱フォント）。**
hide の実機確認 4 件（82-7 音と印・75-21 テーマ追随・82-2 名前入力面・パレット並びは現状で可）はすべて OK。
**判断待ちは #112 と 82-9 / 100%・150%・简体中文・配色だけ。**
最新は[日報](docs/reports/2026-09-25.md)の「終盤」/ [引き継ぎ](docs/handoffs/2026-09-25.md)。
